 ...
 * type e2 = Contains<['foo', 'bar', null, 'baz', null, null], string> // true
 * type e3 = Contains<[number, ...'foo'[], number], string> // true
 * type e4 = Contains<[number, ...'foo'[], number], 'bar'> // false
 * type e5 = Contains<[number, ...'foo'[], number], string, 'equals'> // false
 * type e6 = Contains<['foo', 'bar', 'baz', null, 'qux'?], 'qux'> // true
 ...
 * type e7 = Contains<t7, 511> // true
 * type e8 = Contains<t7, 512> // false 
 * 
 */

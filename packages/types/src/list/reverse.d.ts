...
type _Reverse<L extends List, Acc extends List = []> =
  ...
  : L extends [_?: infer H, ...__: infer T] ? _Reverse<T, [H, ...Acc]>
  : Concat<L, Acc>
 ...
 * 
 * type e3 = Reverse<[string, number, boolean?]> // [boolean, number, string]
 * type e4 = Reverse<[string, number, (boolean | undefined)?, symbol?]> // [symbol, boolean, number, string]
 */

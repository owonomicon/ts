 ...
 */
export type AddNonneg_Safe<N1 extends ValidateNonnegInt<N1>, N2 extends ValidateNonnegInt<N2>> =
...
export type Add_Safe<N1 extends ValidateInt<N1, 'N1'>, N2 extends ValidateInt<N2, 'N2'>> = ValidateInt<N1> extends number ? ValidateInt<N2> extends number ? [N1, N2] extends [infer N1 extends number, infer N2 extends number] ? Add<N1, N2> : Unreachable : never : never;
